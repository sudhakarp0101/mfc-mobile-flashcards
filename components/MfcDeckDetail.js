...
export class MfcDeckDetail extends Component {
    static propTypes = {
            ...
            <View style={styles.container}>
                ...
                <View>
                    <TouchButton
                        ...
                        onPress={() =>
                            this.props.navigation.navigate('MfcAddCard', { title: deck.title })
                        }
                    >
                        Add Card
          </TouchButton>
                    <TouchButton
                        ...
                        onPress={() =>
                            this.props.navigation.navigate('MfcQuiz', { title: deck.title })
                        }
                    >
                        Start Quiz
          </TouchButton>
